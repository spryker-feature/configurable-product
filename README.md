...
- [ProductConfigurationShoppingList ^1.3.0](https://github.com/spryker/product-configuration-shopping-list) (Connector)
- [ProductConfigurationShoppingListsRestApi ^1.3.0](https://github.com/spryker/product-configuration-shopping-lists-rest-api) (Legacy Glue)
...
- [Shop.ProductConfigurationShoppingListWidget ^1.1.0](https://github.com/spryker-shop/product-configuration-shopping-list-widget) (Connector)
...
- [ProductConfigurationsPriceProductVolumesRestApi ^1.1.0](https://github.com/spryker/product-configurations-price-product-volumes-rest-api) (Legacy Glue)
- [ProductConfigurationsRestApi ^1.3.0](https://github.com/spryker/product-configurations-rest-api) (Legacy Glue)
...
- [ProductConfigurationWishlist ^1.1.0](https://github.com/spryker/product-configuration-wishlist) (Connector)
- [ProductConfigurationWishlistsRestApi ^1.5.0](https://github.com/spryker/product-configuration-wishlists-rest-api) (Legacy Glue)
...
- [Shop.ProductConfigurationWishlistWidget ^1.1.0](https://github.com/spryker-shop/product-configuration-wishlist-widget) (Connector)
